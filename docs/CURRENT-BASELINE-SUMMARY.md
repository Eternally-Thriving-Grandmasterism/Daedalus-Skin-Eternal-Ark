# DSA-Ref-A Current Baseline Summary
...
| Dedicated radiation shielding | **450–750 t** |
...
| Deceleration (low density + residual) | **25–40 years** |
| Continuous power capability | **≥ 5–8 MW** |

## 3. Technology Maturation Status

| Thread | Focus | Status |
|--------|-------|--------|
| A | Fusion drive & magnetic nozzle | Gate 1 protocols defined; physical testing required |
| B | Rotating habitat mechanics | Gate 1 protocols defined; physical testing required |
| C | Closed-loop life support | Gate 1 protocols defined; physical testing required |
| D | Daedalus-Skin materials | Requirements defined; coupon testing required |
| E | Magnetic sail | Architecture & mass locked; Gate E1 deployment plan issued |
| F | Radiation shielding | Dose targets & mass locked; Monte-Carlo confirmation pending |

## 4. Key Governing Documents
...
- [MASTER-INDEX.md](MASTER-INDEX.md) — Full navigation

## 5. Realism Statement (Unchanged)

Sustained multi-year D–³He ICF, industrial-scale ³He supply, radiation-hardened self-healing large structures, and multi-decade integrated reliability remain well beyond demonstrated technology. The repository is a coherent baseline and risk-management framework — not a claim of near-term constructability.

## 6. Next Physical Steps

1. Gate 1 execution for Threads A, B, C
2. Gate E1 magnetic-sail subscale deployment
...
**This summary is the single-page authoritative snapshot of the locked DSA-Ref-A baseline under TOLC 8.**
